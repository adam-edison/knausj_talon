...
# File Commands
(file hunt | search file) [<user.text>]: 
  key(cmd-p)
  sleep(50ms)
  insert(text or "")
...
(fix format|formatting): user.vscode("editor.action.formatDocument")
...
close others: key(cmd-alt-t)

# TODO: AGE: extract this into a generic ide command
open only <user.text> [talon]:
  key(cmd-p)
  sleep(100ms)
  insert(text)
  insert(" talon")
